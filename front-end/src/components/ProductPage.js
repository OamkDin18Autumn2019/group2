...
export default class ProductPage extends Component {
    ...
    componentDidMount() {
        ...
        axios.get(`http://ec2-3-82-236-93.compute-1.amazonaws.com:4000/v1/product/${idProduct}`, {
            headers: {
                        ...
                        <div className="container py-4">
                            <div className={styles.mainCon}>
                                <div className="d-flex align-content-start flex-wrap p-4">
                                    <div className="col-md-4 col-s-12 col-lg-5"><img className={styles.productImg} alt="product" src={`http://ec2-3-82-236-93.compute-1.amazonaws.com:4000/${this.state.data.images}`}></img></div>
