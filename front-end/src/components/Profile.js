...
export default class Profile extends Component {
  ...
  componentDidMount() {
    ...
    axios.get(`https://back-end-for-anystore.herokuapp.com/v1/user/da/getHistory`, {
      headers: {
    ...
    if (!userId) {
      axios.get(`https://back-end-for-anystore.herokuapp.com/v1/product/da/currentSellings/${this.props.user.userId}`, {
        headers: {
          'x-access-token': this.props.user.token
        }
      })
      ...
      axios.get(`https://back-end-for-anystore.herokuapp.com/v1/product/da/currentSellings/${userId}`, {
        headers: {
          'x-access-token': this.props.user.token
        }
      })
      ...
      if (!userId) {
        axios.get(`https://back-end-for-anystore.herokuapp.com/v1/user/${this.props.user.userId}`, {
          headers: {
            'x-access-token': this.props.user.token
          }
        })
        ...
        axios.get(`https://back-end-for-anystore.herokuapp.com/v1/user/${userId}`, {
        headers: {
          'x-access-token': this.props.user.token
        }
      })
