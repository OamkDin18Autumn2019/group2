...
export default class Profile extends Component {
  ...
  componentDidMount() {
    ...
    axios.get(`http://ec2-3-85-131-156.compute-1.amazonaws.com:4000/v1/user/da/getHistory`, {
      headers: {
    ...
    if (!userId) {
      axios.get(`http://ec2-3-85-131-156.compute-1.amazonaws.com:4000/v1/product/da/currentSellings/${this.props.user.userId}`, {
        headers: {
          'x-access-token': this.props.user.token
        }
      })
      ...
      axios.get(`http://ec2-3-85-131-156.compute-1.amazonaws.com:4000/v1/product/da/currentSellings/${userId}`, {
        headers: {
          'x-access-token': this.props.user.token
        }
      })
      ...
      if (!userId) {
        axios.get(`http://ec2-3-85-131-156.compute-1.amazonaws.com:4000/v1/user/${this.props.user.userId}`, {
          headers: {
            'x-access-token': this.props.user.token
          }
        })
        ...
        axios.get(`http://ec2-3-85-131-156.compute-1.amazonaws.com:4000/v1/user/${userId}`, {
        headers: {
          'x-access-token': this.props.user.token
        }
      })
