    ...
    changeRating = (newRating, name) => {
        if (this.props.user.username !== "") {
            if (this.state.rating == null) {
                axios.put(`http://ec2-3-82-236-93.compute-1.amazonaws.com:4000/v1/product/changeRating/${this.props.id}`, {
                    // headers: {
        ...
        return (
            <>
                <div className={styles.img_block}>
                    <div className={styles.content_block}><img alt="product" src={`http://ec2-3-82-236-93.compute-1.amazonaws.com:4000/${this.props.images}`} />
