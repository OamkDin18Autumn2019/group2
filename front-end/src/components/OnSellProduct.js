...
export default function OnSellProduct(props) {
    ...
    const deleteProduct = (e) => {
        ...
        axios.delete(`http://ec2-3-82-236-93.compute-1.amazonaws.com:4000/v1/product/${props.id}`, {
          headers: {
    ...
    return(
        ...
        <div className={styles.OnSellProduct}>
            <div className={styles.ImageAndDescription}>
                <img src={`http://ec2-3-82-236-93.compute-1.amazonaws.com:4000/${props.images}`} class="img img-fluid" alt="Padoru Padoru!" />
