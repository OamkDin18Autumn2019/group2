...
export default class LandingPage extends React.Component {
    ...
    componentDidMount() {
        ...
        axios.get(`https://back-end-for-anystore.herokuapp.com/v1/product/da/newArrivals`, {
            headers: {
        ...
        axios.get(`https://back-end-for-anystore.herokuapp.com/v1/product/da/bestSellers`, {
            headers: {
                'x-access-token': this.props.user.token
            }
        })
        ...
        axios.get(`https://back-end-for-anystore.herokuapp.com/v1/product/da/discounts`, {
            headers: {
                'x-access-token': this.props.user.token
            }
        })
